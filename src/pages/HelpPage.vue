    ...
    topics: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Tambah ODP dan pilih induknya: langsung ke OLT (estafet) atau lewat ODC. Untuk ODP via ODC, pilih Line Keluaran ODC-nya.',
          'Satu line bisa berisi RANTAI beberapa ODP (estafet dengan splitter asimetris, mis. tap 10% → 20% → 50% → sisa): atur posisi dengan "Urutan ODP" dan porsi sinyal dengan "Rasio (%)" — ODP terakhir memakai rasio 100%.',
          'Kapasitas dijaga otomatis: sistem menolak line/cabang melebihi rasio ODC (mis. ODC 1:4 maksimal 4 line), menolak urutan ganda di line yang sama, dan mencegah induk melingkar.',
          'Isi jumlah port dan koordinat; port ODP dibuat otomatis, dan okupansinya tersinkron dua arah dengan data pelanggan FTTH.',
          'Buka detail ODP untuk melihat Jalur ke OLT lengkap dan Rantai Line-nya — Link Budget dihitung otomatis menembus ODC dan tap ODP pendahulu.',
        ],
    ...
    topics: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Klik angka Aktif / Online / Offline / Isolir di atas daftar untuk memfilter pelanggan sesuai status; klik lagi untuk kembali ke semua.',
          'Klik baris pelanggan untuk panel detail cepat (IP, uptime, kecepatan real-time, jatuh tempo) tanpa pindah halaman — lengkap dengan aksi isolir/aktifkan/hapus.',
        ],
